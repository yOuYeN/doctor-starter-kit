...
準備好開始了嗎？請把你的書籍或期刊 PDF 的完整路徑貼給我，例如：
/Users/yourname/Documents/mybook.pdf

（不知道路徑的話：在 Finder 找到檔案，按住 Option 鍵右鍵 → 「拷貝⋯為路徑名稱」）
```

收到路徑後，確認檔案存在，再一次問完以下問題：

```
謝謝！再回答幾個問題，我就可以開始了：

1. 演講時間多長？用途是什麼？（例：一小時教學課）
2. 要涵蓋整本書還是特定章節？
3. 有沒有特別想加的概念？（白話說，我去書裡找）
4. 投影片語言：中文 / 英文 / 中英混合？
```
